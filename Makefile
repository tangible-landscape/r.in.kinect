...
EXTRA_CFLAGS = -Wall -fsanitize=address -g -std=c++14 -march=native  -Wno-deprecated -O0 $(VECT_CFLAGS) $(OMPCFLAGS) $(ORBBEC_LIB_PATH) $(ORBBEC_LIB) -static-libasan

LDFLAGS += $(ORBBEC_LIB_PATH) $(ORBBEC_LIB)

include $(MODULE_TOPDIR)/include/Make/Module.make

LINK = $(CXX) -fsanitize=address
